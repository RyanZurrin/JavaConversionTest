...
public class ConversionTest {
    ...
    public static void main(String[] args) {
        System.out.println("To: \t" + "bool\t" + "byte\t" + "char\t" + "short\t" + "int\t" + "long\t" + "float\t" + "double\t" + "Byte\t" + "Short\t" + "Boolean\t" + "Character\t" + "Integer\t" + "Long\t" + "Float\t" + "Double\t");
        ...
        Class<?>[] classes;
        // define the classes to be used in the table
        classes = new Class<?>[]{boolean.class, byte.class, char.class, short.class, int.class, long.class, float.class, double.class,
